...
/**
 * Represents a city (vertex) in the Ghana Road Transport Network directed graph.
 *
 * <p>Each {@code City} holds a name and a map of outgoing edges to neighboring cities.
 * Every edge carries two weights: the road distance in kilometres and the average
 ...
 *
 * <p>The neighbors map uses the neighbor city's name as the key and a two-element
 * {@code int[]} as the value:</p>
 * <ul>
...
public class City {
    ...
    /**
     * Constructs a new {@code City} with the given name and an empty neighbor map.
     *
     * @param name the name of the city; must not be {@code null}
     */
    ...
    /**
     * Adds a directed edge from this city to the specified neighbor.
     *
     * <p>If an edge to the same neighbor already exists, it is overwritten
     * with the new distance and time values.</p>
     *
     * @param neighborName the name of the destination city
    ...
    /**
     * Removes the directed edge from this city to the specified neighbor.
     *
     * <p>If no such edge exists, this method does nothing.</p>
     *
     * @param neighborName the name of the neighbor city to disconnect
     */
     ...
     *
     * @param neighborName the name of the neighbor city to look up
    ...
    /**
     * Checks whether a directed edge exists from this city to the given neighbor.
     *
     * @param neighborName the name of the city to check
    ...
    /**
     * Returns a concise string representation of this city, including the
     * city name and the number of outgoing edges.
     *
     * @return a string in the format {@code City{name='X', neighbors=N}}
     */
    @Override
    public String toString() {
        return "City{name='" + name + "', neighbors=" + neighbors.size() + "}";
    }
}
